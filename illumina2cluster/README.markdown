...
Prepare sample sheet files for Illumina sequencers for input into bcl-to-fastq
conversion process (e.g. CASAVA or bcl2fastq).
...
`SampleSheet2.csv`:
    ...
    prep_sample_sheet.py -o SampleSheet2.csv -f CASAVA --set-project=1,8:Control \
