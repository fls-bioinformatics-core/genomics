...
class TestProbeSetLookup(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.fp1 = cStringIO.StringIO("""ps_1	gid_1	gid_2	ps_2
...
""")
        self.fp2 = cStringIO.StringIO("""ps_1	gid_1	gid_2	ps_2
...
class TestIndexedFile(unittest.TestCase):
    ...
    def setUp(self):
        # Example data
        self.fp = cStringIO.StringIO("""1007_s_at	U48705	chr6:30856165-30867931 (+) // 95.63 // p21.33	discoidin domain receptor tyrosine kinase 1	DDR1	900.8253051	1002.945639	0.898179	-1.11336
...
class TestCombineData(unittest.TestCase):
    def setUp(self):
        # Example data
        self.species1 = """Probe_Set_ID	Public_ID
1053_at	M87338
117_at	X51757
121_at	X69699
1255_g_at	L36861
"""
        self.species2 = """Probe_Set_ID	Public_ID
...
1437317_at	BB735820
"""
        self.lookup_data = """ps_1	gid_1	gid_2	ps_2
1053_at	5982	19718	1417503_at,1457638_x_at,1457669_x_at
117_at	3310	NA	NA
121_at	7849	18510	1418208_at,1446561_at
1255_g_at	2978	14913	1421061_at
1294_at	7318	74153	1426970_a_at,1426971_at,1437317_at
"""
        self.expected_output = """Probe_Set_ID	Public_ID	Probe_Set_ID_1	Public_ID_1	Probe_Set_ID_2	Public_ID_2	Probe_Set_ID_3	Public_ID_3
...
"""
    ...
    def test_combine_data(self):
        ...
        """
        # Input data
        data1 = IndexedFile(fp=cStringIO.StringIO(self.species1),first_line_is_header=True)
        data2 = IndexedFile(fp=cStringIO.StringIO(self.species2),first_line_is_header=True)
        lookup = ProbeSetLookup(lookup_data_fp=cStringIO.StringIO(self.lookup_data))
        # Output "file"
