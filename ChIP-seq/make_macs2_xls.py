    ...
    def __init__(self,filen=None,fp=None,name=None):
        ...
        for line in fp:
            ...
            if line.startswith('#') or line == '':
                ...
                if self.__name is None and line.startswith("# name = "):
...
def xls_for_macs2(macs_xls):
    ...
    macs_xls.sort_on('-log10(pvalue)',reverse=True)
...
"""
    ...
    notes.append_row(text="By default regions are sorted by Pvalue and fold enrichment "
                     "(in descending order)")
...
MACS14_data = """# This file is generated by MACS version 1.4.0beta
# ARGUMENTS LIST:
...
MACS2_data = """# This file is generated by MACS version 2.0.10.20130419 (tag:beta)
# ARGUMENTS LIST:
...
class TestMacsXLSForMac14(unittest.TestCase):
    def test_load_macs14_xls_file(self):
        """Load data from MACS14 variant

        """
        macsxls = MacsXLS(fp=cStringIO.StringIO(MACS14_data))
...
class TestMacsXLSForMac2(unittest.TestCase):
    def test_load_macs2_xls_file(self):
        """Load data from MACS2 variant

        """
        macsxls = MacsXLS(fp=cStringIO.StringIO(MACS2_data))
...
class TestXlsForMacs2Function(unittest.TestCase):
    def test_xls_for_macs2(self):
        """Generate XLSWorkBook for MACS2 data
        ...
        self.assertEqual(data['O6'],5.62653)
    def test_xls_for_macs2_with_macs14_input(self):
