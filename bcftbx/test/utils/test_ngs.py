...
import shutil
import gzip
from bcftbx.utils.ngs import getreads
from bcftbx.utils.ngs import getreads_subset
from bcftbx.utils.ngs import getreads_regex
...
"""
    ...
    def test_getreads_fastq(self):
        ...
        with open(example_fastq,'wt') as fp:
    ...
    def test_getreads_csfasta(self):
        ...
        with open(example_csfasta,'wt') as fp:
    ...
    def test_getreads_qual(self):
        ...
        with open(example_qual,'wt') as fp:
...
"""
    ...
    def test_getreads_regex_fastq(self):
        """
        getreads_regex: get reads from Fastq file matching pattern
        """
        # Make an example file
        example_fastq = os.path.join(self.wd,"example.fastq")
        with open(example_fastq,'wt') as fp:
